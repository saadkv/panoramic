 ...
 * @package panoramic
 */
define( 'PANORAMIC_THEME_VERSION' , '1.0.28' );
...
if ( ! function_exists( 'panoramic_load_dynamic_css' ) ) :
	...
	function panoramic_load_dynamic_css() {
		...
		$panoramic_slider_min_width = get_theme_mod( 'panoramic-slider-min-width', customizer_library_get_default( 'panoramic-slider-min-width' ) );
...
if (!function_exists('panoramic_loop_shop_columns')) {
	...
	function panoramic_loop_shop_columns() {
		if ( get_theme_mod( 'panoramic-layout-woocommerce-shop-full-width', false ) || ! is_active_sidebar( 'sidebar-1' ) ) {
			return 4;
		} else {
			return 3;
		}
